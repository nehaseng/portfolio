...
*We begin  by answering some of the questions like*
- What is the shape of the data (number of rows & columns)
- Are there any summary/header/footer rows?
- Presence of null values in rows/columns?
- What kind of data is available,from a business perspective?

*We found was there are mainly 3 types of data present in the dataset*
- Consumer demographics: such as annual_inc, home_ownership, emp_length
- Loan attributes: such as int_rate, loan_amt,term etc
- Data/columns which are calculated only after loan is approved:total_payment, revol_bal etc

#### STEP 2: Data cleaning and Manipulation ####

*Next,We address various data quality issues by*
...
*Finally we understand our `target variable` "Loan status" and begin EDA in the following order*
